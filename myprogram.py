...
# Labels
label_1=Tkntr.Label(menu_inicial, text = "Este o label 1", bg="yellow", fg="black", font="Arial 20", width=20)
label_2=Tkntr.Label(menu_inicial, text = "Este o label 2", bg = "#FF0000", fg="black", font="Arial 10", width = 20,  anchor='center')
label_3= Tkntr.Label(menu_inicial, textvariable=textolabel, bg="orange", font = "Times 30", bd=1, relief= "solid", width = 15, height=2, anchor='nw')
label_4= Tkntr.Label(menu_inicial, text="Label Numero 4", bg="blue", font = "Arial 10", bd=1, relief= "raised", width = 15, height=3, anchor='nw', padx=50)
label_5= Tkntr.Label(menu_inicial, text="Label Numero 4\nEste eh um texto original\nCom multiplas linhas",
                    bg="gray",font = "Arial 15", bd=3, relief= "raised", width=60, height=4, anchor="w", justify="left")
...
# Botoes
btn_File = Tkntr.Button(menu_inicial, text= "File", command=lambda: OnClick_FileButton(), bg="gray", borderwidth=1, relief="raised")
btn_Settings = Tkntr.Button(menu_inicial, text= "Settings", bg="gray", command=lambda: OnClick_SettingsButton(), borderwidth=1, relief="raised")
btn_Tools = Tkntr.Button(menu_inicial, text= "Tools", bg="gray", command=lambda: OnClick_ToolsButton(), borderwidth=1, relief="raised")
btn_BotaoExtra1 = Tkntr.Button(menu_inicial, text= "BotaoExtra 1", bg="gray", borderwidth=1, relief="raised")
btn_BotaoExtra2 = Tkntr.Button(menu_inicial, text= "BotaoExtra 2", bg="gray", borderwidth=1, relief="raised")
btn_BotaoExtra3 = Tkntr.Button(menu_inicial, text= "BotaoExtra 3", bg="gray", borderwidth=2, relief="raised")
